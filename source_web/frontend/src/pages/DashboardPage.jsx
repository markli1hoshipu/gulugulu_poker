...
// Import the Enhanced Lead Generation component
import EnhancedLeadGeneration from '../components/lead-gen/EnhancedLeadGeneration';
import CustomerSuccessDashboard from '../components/crm/CustomerSuccessDashboard';
...
function DashboardPage() {
    ...
    return (
        <div className="dashboard-container min-h-screen flex" style={{height: '100vh'}}>
            ...
            <div className="w-80 border-r border-gray-200" style={{
                ...
                <SidebarMenu
                    ...
                    onToggleLoading={toggleLoadingEnabled}
                />
            </div>
