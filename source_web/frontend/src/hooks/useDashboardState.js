...
export const useDashboardState = () => {
    ...
    // UI State - default to leads (dashboard temporarily disabled)
    const [currentView, setCurrentView] = useState('leads');  // Changed from 'dashboard' to 'leads' as dashboard is temporarily disabled

    // const [currentView, setCurrentView] = useState('calendar');
    const [isMobile, setIsMobile] = useState(false);
    const [isSidebarCollapsed, setIsSidebarCollapsed] = useState(false);
    const [isMobileSidebarOpen, setIsMobileSidebarOpen] = useState(false);
    const [isChatViewHidden, setIsChatViewHidden] = useState(false);
