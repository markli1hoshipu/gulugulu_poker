...
const Navigation = ({ isChatVisible, onToggleChatVisibility, isWsConnected, loadingEnabled, onToggleLoading }) => {
  ...
  const handleProfilesClick = () => {
    ...
    console.log('Navigation: Navigating to /profiles');
    navigate('/profiles');
    setUserMenuOpen(false);
    setMobileMenuOpen(false);
  };
  ...
  return (
    <nav className="navigation-bar w-full" role="navigation" aria-label="Main navigation" style={{backgroundColor: 'rgb(225, 239, 242)'}}>
            ...
            {isAuthenticated && (
              <>
                ...
                <_motion.button
                  ...
                  className="flex items-center justify-center w-12 h-12 text-gray-800 hover:text-gray-900 transition-colors rounded-lg hover:bg-cyan-200"
                  title="User Menu"
                >
          ...
          <div className="lg:hidden">
            {isAuthenticated && (
              <_motion.button
                ...
                className="text-gray-800 hover:text-gray-900 transition-colors p-3 rounded-md hover:bg-cyan-200"
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <_motion.div
              ...
              style={{backgroundColor: 'rgb(225, 239, 242)'}}
            >
              <div className="px-6 pt-6 pb-8 space-y-4">
                ...
                {/* Mobile User Info */}
                <div className="flex items-center space-x-4 pb-4 border-b border-cyan-200 text-gray-800">
                  {user?.picture ? (
                    <img 
                      src={user.picture} 
                      alt="Profile" 
                ...
                <button
                  onClick={handleProfilesClick}
                  className="flex items-center space-x-3 w-full text-left px-4 py-3 rounded-md text-gray-800 hover:text-gray-900 hover:bg-cyan-200 transition-colors font-inter text-base"
                >
