...
```javascript
// Individual imports
import { Button, IconButton, ActionButton } from '@/components/shared/buttons';
import { Table, TableHeader, TableRow, TableCell } from '@/components/shared/tables';
import { FormField, FormGroup } from '@/components/shared/forms';
