 ...
 * Supports nl2sql, employee, crm, and lead-gen services
...
class UploadService {
  constructor(config) {
    ...
    this.serviceEndpoints = {
      'nl2sql': {
        baseUrl: import.meta.env.VITE_NL2SQL_API_URL || 'http://localhost:8002',
        uploadEndpoint: '/api/data/upload',
        analyzeEndpoint: '/api/data/analyze'
      },
      'employee': {
        baseUrl: import.meta.env.VITE_EMPLOYEE_URL || 'http://localhost:7001',
        uploadEndpoint: '/employees/upload',
        analyzeEndpoint: '/employees/analyze'
      },
      'crm': {
  ...
  getServiceConfig() {
    const serviceConfigs = {
      ...
      'employee': {
        ...
        expectedColumns: ['name', 'email', 'role', 'department'],
        icon: 'Users'
      },
      'crm': {
