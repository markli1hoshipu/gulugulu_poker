...
const TrendChart = ({
  ...
  // Unified Prelude Brand Color Schemes
  const colorSchemes = {
    // Primary Prelude Blue (Dark) - For key metrics
    blue: {
      primary: '#031D4A',
      light: '#f0f4ff'
    },
    // All other colors now use Prelude blue variations for consistency
    green: {
      primary: '#031D4A',
      light: '#f0f4ff'
    },
    ...
    if (active && payload && payload.length) {
      ...
      return (
        <div className="bg-white p-3 border border-gray-200 rounded-lg shadow-lg">
          ...
          {actualData && (
            <p className="text-sm font-semibold" style={{ color: colorSchemes[color].primary }}>
